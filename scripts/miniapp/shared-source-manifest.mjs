...
const MANIFEST_SOURCE = `/* SHARED_SOURCE_MANIFEST_START
{
  "shared": [
    ...
    "src/domain/effective-traits.js",
    "src/domain/skill-damage-ranking.js",
    "src/features/damage-comparison/useDamageComparison.js",
