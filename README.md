...
- 同时配置攻防双方的精灵、性格、个体和技能。
- 即时查看技能伤害、生命占比和剩余生命。
- 支持队伍预设、四技能对比和常见条件触发。
- 配置只保存在你的设备上，不会上传个人队伍数据。
...
参考页面仅用于资料核验和规则研究，不作为本项目的运行时依赖。具体权利与授权边界见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。

## 许可证与声明

项目源代码采用 [MIT License](LICENSE)。游戏名称、角色、图像、图标和相关素材的权利归其各自权利人所有；本项目为非官方玩家工具，与腾讯、魔方工作室群及 BWIKI 无隶属或授权关系。
