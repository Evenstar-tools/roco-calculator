...
describe("versioned share state", () => {
  ...
  test("keeps the complete v1 share bytes stable", async () => {
    await expect(encodeShareState(shareFixture())).resolves.toBe(
      "#v1..8ead1cb16963",
    );
  });
  ...
  test("rejects individual values above the in-game cap of 60", async () => {
    const state = shareFixture();
    state.sides.attacker.displayIvs.speed = 61;

    await expect(encodeShareState(state)).rejects.toThrow(
      "sides.attacker.displayIvs.speed 无效",
    );
  });
