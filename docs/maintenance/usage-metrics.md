...
状态：代码准备中，RUM 未开通；只有生产域名 https://rococalc.top 且 VITE_RUM_ENABLED=true、VITE_RUM_ID 已设置才采集。桌面、本地、预览不采集。
...
腾讯云主账号每日共享 50 万条免费额度，广州超额按 0.34 元/万条；免费额度不是零超支硬保证。用户尚未同意开通按量付费，不能据代码完成宣称云端已启用。
